  ...
  if (isLoading) {
    return (
      <div className="min-h-screen grid place-items-center bg-background">
        <div className="text-center text-foreground/70">Loading profile…</div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen grid place-items-center bg-background px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-foreground/70 mt-2">{error || "The profile you're looking for doesn't exist or could not be loaded."}</p>
          <Link to="/" className="btn btn-primary mt-6 inline-flex"><ArrowLeft className="h-4 w-4 mr-2" /> Go home</Link>
        </div>
      </div>
    )
  }
